...
```
При этом  надо помнить, что весь обмен идет нешифрованным, а также на snmp-запросы железка откликнется откуда бы он ни пришел. чтобы защититься - необходим SNMP ACL:
